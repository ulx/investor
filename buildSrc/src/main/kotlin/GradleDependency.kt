object GradlePluginVersion {
    ...
    const val FRBRIC_GRADLE = "1.31.0"
    const val GOOGLE_SERVICE_GRADLE = "4.3.3"
    const val FIREBASE_GRADLE = "1.1.5"
    const val KOIN_GRADLE = "2.1.3"
}

object GradlePluginName {
...
object GradlePluginId {
    ...
    const val FABRIC_PLUGIN = "io.fabric.tools:gradle"
    const val GOOGLE_SERVICE_PLUGIN = "com.google.gms:google-services"
    const val FIREBASE_PLUGIN = "com.google.firebase:firebase-plugins"
    const val KOIN_PLUGIN = "org.koin:koin-gradle-plugin"
}
